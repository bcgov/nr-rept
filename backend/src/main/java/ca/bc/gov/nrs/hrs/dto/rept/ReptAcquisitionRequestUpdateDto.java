...
/**
 * Request payload for updating an existing acquisition request. The revision count is required
 * for optimistic locking.
 */
public record ReptAcquisitionRequestUpdateDto(
  ...
  public ReptAcquisitionRequestUpdateDto {
